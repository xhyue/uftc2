...
class ParkingLot(models.Model):
    ...
    province = models.CharField(verbose_name='省', max_length=50, unique=True)
    city = models.CharField(verbose_name='市', max_length=50, unique=True)
    area = models.CharField(verbose_name='区', max_length=50, unique=True)
    address = models.CharField(verbose_name='详细地址', max_length=200)
    longitude = models.DecimalField(verbose_name='经度', max_digits=10, decimal_places=6)
    latitude = models.DecimalField(verbose_name='维度', max_digits=10, decimal_places=6)
