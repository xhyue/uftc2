...
class ParkingRecord(models.Model):
    ...
    entry_picture = models.ImageField(verbose_name='驶入图片', upload_to='static/img/entry')
    exit_picture = models.ImageField(verbose_name='驶出图片', upload_to='static/img/exit')
